...
import {
  memoTheme_default
} from "./chunk-R3ZMD2PF.js";
import {
  useDefaultProps
} from "./chunk-GMZHK4RH.js";
import {
  _extends,
  clsx_default,
  composeClasses,
...
function useButtonBase(parameters) {
  ...
  const hasNativeKeyboardActivation = React8.useCallback(() => {
    const root = rootRef.current;
    if (root == null) {
      return nativeButton;
    }
  ...
  const getButtonProps = React8.useCallback((externalProps = EMPTY) => {
    const {
